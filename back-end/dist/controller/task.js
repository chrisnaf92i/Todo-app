...
exports.changeDoneTask = exports.deleteTask = exports.get = void 0;
...
const changeDoneTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    if (!id) {
        res.status(400).json({ message: "l'id est requis" });
    }
        ...
        try {
            yield task_repository_1.default.setDoneTask(id);
...
exports.changeDoneTask = changeDoneTask;
